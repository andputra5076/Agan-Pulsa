...
<!--Title-->
<title>Riwayat Deposit via Tripay</title>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button class="view_deposit btn btn-primary btn-small" data-toggle="modal" id="<?php echo $data_depo['id']; ?>" data-target='#myDetail'><i class="mdi mdi-view-list mdi-18px"></i></button><br /><br />
                                    <a href="<?php echo $config['web']['url'];?>invoice-va.php" class="btn btn-<?php echo $klik; ?> <?php echo $btn; ?> btn-small"><i class="mdi mdi-<?php echo $action; ?> mdi-18px"></i></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('.view_deposit').click(function(){
            ...
            // memulai ajax
            $.ajax({
                url: '/riwayat/ajax/detail-deposit-bank.php',
                method: 'post',		
                data: {id:id},	
