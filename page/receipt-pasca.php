...
require '../lib/header.php';
	...
	if (isset($_GET['oid'])) {
		...
		$cek_pesanan = $conn->query("SELECT * FROM pembelian_pascabayar WHERE oid = '$kode_pesanan' AND user = '$sess_username'");
		...
		if ($cek_pesanan->num_rows == 0) {
			header("Location: ".$config['web']['url']."riwayat/pemesanan-pascabayar");
		} else {
?>
...
?></h4><hr>
        ...
        <div class="row">
         ...
         <table class = "table table-bordered table-sm">
                ...
                <tr class="table-danger">
                    <td>HARGA</td>
                    <td contenteditable="true">: Rp. <?php echo number_format($data_pesanan['jumlah_tagihan'],0,',','.'); ?>,-</td>
                </tr>
                <tr class="table-danger">
                    <td>STATUS</td>
                ...
                <tr class="table-danger">
					...
					<center>
                        <a href="<?php echo $config['web']['url']; ?>riwayat/pemesanan-pascabayar" class="btn btn-warning btn-elevate btn-pill btn-elevate-air">Kembali</a>
