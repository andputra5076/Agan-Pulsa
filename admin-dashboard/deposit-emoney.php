                        ...
                        <tbody>
                            ...
                            <tr>
                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>?id_deposit=<?php echo $data_depo['kode_deposit']; ?>" class="form-inline" role="form" method="POST"> 
                                    ...
                                    <td align="center">
                                        <a href="javascript:;" onclick="deposit('<?php echo $config['web']['url'];?>admin-dashboard/ajax/deposit/view-deposit-emoney.php?kode_deposit=<?php echo $data_depo['kode_deposit']; ?>')" class="btn btn-sm btn-primary">
