...
?>
                                    <tr> 
                                        ...
                                        <td align="center">
                                            <a href="javascript:;" onclick="users('/admin-dashboard/ajax/layanan-sosmed/edit.php?id_layanan=<?php echo $data_layanan['id']; ?>')" class="btn btn-xs btn-warning"><i class="fa fa-pencil" title="Edit"></i> Update </a>
                                            <a href="javascript:;" onclick="users('/admin-dashboard/ajax/layanan-sosmed/delete.php?id_layanan=<?php echo $data_layanan['id']; ?>')" class="btn btn-xs btn-danger"><i class="fa fa-trash" title="Hapus"></i> Delete </a>
                                        </td>                                 
                                    </tr>  
<?php } ?>
                                    </tbody>
