...
//TOP SOSMED BULANAN
$pembelian_sosmed_month = $conn->query("SELECT SUM(pembelian_sosmed.harga) AS total_pembelian, count(pembelian_sosmed.id) AS tcount, pembelian_sosmed.layanan, layanan_sosmed.kategori, layanan_sosmed.layanan, layanan_sosmed.tipe FROM pembelian_sosmed JOIN layanan_sosmed ON pembelian_sosmed.layanan = layanan_sosmed.layanan WHERE MONTH(pembelian_sosmed.date) = '".date('m')."' AND pembelian_sosmed.status = 'Success' GROUP BY pembelian_sosmed.layanan ORDER BY tcount DESC LIMIT 10");
...
<div class="row">
	<div class="col-md-12">
		<div class="card-box">
			...
			<div class="card">
				<div class="card-body">
					<h4 class="m-t-0 text-uppercase text-center header-title"><i class="ti-medall text-primary"></i> Layanan Sosial Media</h4><hr>
					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered nowrap m-0">
							...
							<tbody>
								<?php 
								$no = 1;
								while($data = mysqli_fetch_array($pembelian_sosmed_month)) {
