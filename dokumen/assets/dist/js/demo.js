...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('LoGin:Akun:MessageShowed')) < Date.now()) {
      localStorage.setItem('LoGin:Akun:MessageShowed', (Date.now()) + (15 * 60 * 1000))
      // eslint-disable-next-line no-alert
      alert('ANDA BERHASIL MASUK, \nkami mendeteksi login anda AMAN!!!')
    }
  }, 1000)
  ...
  $container.append(
    '<h5>Customize LoGin</h5><hr class="mb-2"/>'
  )
