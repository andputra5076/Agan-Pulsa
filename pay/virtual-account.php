...
if (isset($_POST['request'])) {
	...
	if (!$post_jenis || !$post_pembayaran || !$post_jumlah) {
        ...
        if ($data_metod['tipe'] == "Virtual-Account") {
...
<div class="row">
	<div class="col-md-7">
		<div class="card">
			<div class="card-body">
				<h4 class="m-t-0 text-uppercase text-center header-title"><i class="ti-wallet text-primary"></i> DEPOSIT Virtual-Account
				<?php
                    //INFO STATUS DEPOSIT
					$cek_status = $conn->query("SELECT * FROM metode_depo1 WHERE tujuan IN ('Yabgroup') AND tipe = 'Virtual-Account' AND keterangan = 'OFF' AND Jalur='Auto'");
