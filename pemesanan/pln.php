		...
		$api_link = $data_provider['link'];
            ...
            $header = array(
				...
				if ($conn->query("INSERT INTO pembelian_pulsa VALUES ('','$order_id', '$provider_oid', '$sess_username', '".$data_layanan['layanan']."', '".$data_layanan['harga']."', '".$data_layanan['profit']."', '$post_target', '$post_nometer', '$pesan', 'Pending', '$date', '$time', 'Website', '$provider', '0')") == true) {
					...
					$conn->query("INSERT INTO history_saldo VALUES ('', '$sess_username', 'Pengurangan Saldo', '".$data_layanan['harga']."', 'Order ID $order_id Token Listrik', '$date', '$time')");
		...
		<div class="card">
			<div class="card-body">
				<h4 class="m-t-0 text-uppercase text-center header-title">
				    <img src="/assets/index/PLN.png" alt="Token Pln" style="height: 1.5rem;width: 1.5rem;"></img><b> TOKEN PLN PRABAYAR</b></h4><hr>
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<select class="form-control" name="operator" id="operator">
								...
								<?php
								$cek_kategori = $conn->query("SELECT * FROM kategori_pulsa WHERE tipe IN ('PLN') ORDER BY nama ASC");
