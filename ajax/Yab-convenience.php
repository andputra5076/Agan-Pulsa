...
if (isset($_POST['jenis'])) {
	...
	$cek_metode = $conn->query("SELECT * FROM metode_depo1 WHERE jenis_saldo = '$post_tipe' AND tipe = 'Convenience-Store' AND keterangan = 'ON' AND tujuan = 'Yabgroup' ORDER BY id ASC");
	?>
